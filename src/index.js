...
// Turn Button
const turnSvgEl = document.querySelector(".turn-svg");
...
const restartBtnConfirmEl = document.querySelector(".restart-confirm-btn");
const cancelBtnEl = document.querySelector(".cancel-btn");
const quitBtnEl = document.querySelector(".quit-btn");
const nextRoundBtnEl = document.querySelector(".next-round-btn");
  ...
  if (xSelected) {
    ...
    gameBoardElement.forEach((element) => {
      element.addEventListener("click", () => {
        ...
        const row = element.dataset.row;
        const column = element.dataset.column;
        turnSvgEl.innerHTML = `<svg width="64" height="64" xmlns="http://www.w3.org/2000/svg"><path d="M32 0c17.673 0 32 14.327 32 32 0 17.673-14.327 32-32 32C14.327 64 0 49.673 0 32 0 14.327 14.327 0 32 0Zm0 18.963c-7.2 0-13.037 5.837-13.037 13.037 0 7.2 5.837 13.037 13.037 13.037 7.2 0 13.037-5.837 13.037-13.037 0-7.2-5.837-13.037-13.037-13.037Z" fill="#A8BFC9"/></svg>`;
...
const lightboxDisplay = (winner) => {
  ...
  if (winner === "X") {
    ...
    takesRoundEl.style.color = "#31C3BD";
...
const restartGame = () => {
  ...
  restartBtnConfirmEl.addEventListener("click", handleRestartClick);

  cancelBtnEl.addEventListener("click", () => {
    lightBoxRestartEl.style.display = "none";
  });
